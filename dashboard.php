...
<head>
    ...
    <style>
        ...
        .dash-card {
            ...
            padding: 22px 15px; border-radius: 12px;
            text-align: center; color: white;
            box-shadow: 0 4px 10px rgba(0,0,0,.15);
        }
        .dash-card .numero { font-size: 2rem; font-weight: bold; display: block; }
        .dash-card .label  { font-size: 0.8rem; opacity: .9; margin-top: 5px; display: block; }
        .dc-hospedados { background: linear-gradient(135deg,#2c3e50,#3d5a80); }
        .dc-reservas   { background: linear-gradient(135deg,#f39c12,#e67e22); }
        .dc-clientes   { background: linear-gradient(135deg,#27ae60,#1e8449); }
        .dc-receita    { background: linear-gradient(135deg,#8e44ad,#6c3483); }
        ...
        .hospedado-card .nome { font-weight: bold; font-size: 1rem; }
        .hospedado-card .info { font-size: 0.85rem; color: #555; margin-top: 4px; }
        .hospedado-card .dias {
            float: right; background: #27ae60; color: white;
            padding: 3px 10px; border-radius: 12px; font-size: 0.8rem; font-weight: bold;
        }

        /* ── Ranking bars ── */
        .rank-item { margin-bottom: 14px; text-align: left; }
        .rank-item .rank-label {
            display: flex; justify-content: space-between;
            font-size: 0.88rem; margin-bottom: 4px;
        }
        .rank-item .rank-label .nome { font-weight: bold; }
        .rank-item .rank-label .valor { color: #888; }
        .rank-bar-bg {
            background: #eee; border-radius: 4px; height: 10px; overflow: hidden;
        }
        .rank-bar-fill {
        ...
        .rank-bar-fill.gold   { background: linear-gradient(90deg,#f39c12,#e67e22); }
        .rank-bar-fill.purple { background: linear-gradient(90deg,#8e44ad,#6c3483); }

        .empty-dash { color: #aaa; font-style: italic; font-size: 0.9rem; padding: 10px 0; }

        /* ── Seção hospedados (full width) ── */
        .dash-full { margin-bottom: 30px; }
    </style>
</head>
<body>
<header>
